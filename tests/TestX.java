...
extends KBTestCase
{
   private static final Logger log = Logger.getLogger(TestX.class);
   ...
   /**
	...
	{
		junit.textui.TestRunner.run(TestX.class);
	}
	...
	/*
	 * Random saved stuff from debugging
	 * @author MLB
	 * 
//		Object[] setArgs = {"bar", "baz", new Integer(69)};
//		Loadable set = new ModelSet(toList(setArgs));		
//		Object[] setVariableArgs = {"yow", set};
//		Loadable setVariable = new ModelVariable(toList(setVariableArgs));
//		Object[] structureArgs = {"LoanApplication", intVariable, expression};
//		Object[] structureArgs = {"LoanApplication", intVariable, constraint};
	 */
}
